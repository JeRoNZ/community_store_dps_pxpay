...
abstract class WindCaveCS extends StorePaymentMethod {
	...
	public function redirectForm () {
		...
		// Account2Account does not support card billing
		if (strpos($class, 'CommunityStoreDpsPxpayPaymentMethod') !== false) {
